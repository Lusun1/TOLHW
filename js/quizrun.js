...
function showExplanation(rawanswer) {
    var explanation="";
    try {
    console.log(rawanswer)
        //explanation=questions[globalQTime].qExplanation;
	explanation=questions[globalQTime].Explanations[rawanswer-1].text;
    } catch(e) {
	explanation="";
    }
...
//this help the website keep tracking the time
var lastTime = -1;
...
function addSlideIndex(idxTime) {
    ...
    $(tempDiv).addClass('divInIndex').attr('id','slideIndex'+idxTime+'s').addClass('greyOverlay');
